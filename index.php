...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-3V7ZF3PC1P"></script>
  <script>
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="nav-utility">
              <span class="nav-item">J construction</span>
            </div><!-- .nav-utility -->
          </div><!-- .col-sm-8 -->
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="site-branding">
                <h1 class="site-title title-image" style="color:red">J Construction</h1>
              </div><!-- .site-branding -->
            </div><!-- .col-sm-3 -->
              ...
              <nav id="site-navigation" class="main-navigation" role="navigation">
                ...
                <div class="menu-testing-menu-container">
                  <ul id="primary-menu" class="menu nav-menu" aria-expanded="false">
                    <li class="menu-item current-menu-item"><a href="index-2">Home</a></li>
                    <li class="menu-item"><a href="about">About</a></li>
                    <li class="menu-item menu-item-has-children" aria-haspopup="true"><a href="#">Services</a>
                      <ul class="sub-menu">
                        <li class="menu-item current-menu-item"><a href="service">All Services</a></li>
                        <li class="menu-item"><a href="service-item">Construction Consultant</a></li>
                        <li class="menu-item"><a href="service-item">General Contracting</a></li>
                        <li class="menu-item"><a href="service-item">House Renovation</a></li>
                        <li class="menu-item"><a href="service-item">Construction Management</a></li>
                        <li class="menu-item"><a href="service-item">Design and Build</a></li>
                      </ul>
                    </li>
                    <!-- <li class="menu-item menu-item-has-children" aria-haspopup="true"><a href="#">Features</a>
                      <ul class="sub-menu">
                        ...
                        <li class="menu-item"><a href="single-fullwidth">Single Post Full Width</a></li>
                        ...
                        <li class="menu-item menu-item-has-children" aria-haspopup="true"><a href="#">Shortcodes</a>
                          <ul class="sub-menu">
                            <li class="menu-item"><a href="alert">Alert</a></li>
                            <li class="menu-item"><a href="progress">Progress Bar</a></li>
                            <li class="menu-item"><a href="social">Social Icon</a></li>
                            <li class="menu-item"><a href="button">Button &amp; Label</a></li>
                            <li class="menu-item"><a href="accordion">Accordion</a></li>
                            <li class="menu-item"><a href="tab">Tabs</a></li>
                            <li class="menu-item"><a href="pricing">Pricing</a></li>
                          </ul>
                        </li>
                        <li class="menu-item"><a href="typography">Typography</a></li>
                        <li class="menu-item"><a href="404">Not Found</a></li>
                        <li class="menu-item"><a href="comingsoon">Comingsoon</a></li>
                      </ul>
                    </li> -->
      ...
      <div class="row">
        <div class="col-sm-5">
          <div class="header-caption">
            ...
            <p><strong> J Construction </strong> overall planning, coordination and control of a project, so you don’t
              have to worry about
              anything. Our promise as a contractor is to build community value into every project while delivering
              professional expertise.</p>
            <div class="header-action-button">
              <a class="btn btn-warning btn-md" href="/contact">Contact Us</a>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6">
          <div class="contact-item">
            ...
            <div class="contact-item-info">+91 9040121245</div>
          </div><!-- .contact-item -->
        </div><!-- .col-# -->
        ...
        <div class="col-md-4 col-sm-6">
          <div class="contact-item">
            ...
            <div class="contact-item-info">jethyconstructions@gmail.com</div>
          </div><!-- .contact-item -->
        </div><!-- .col-# -->
        ...
        <div class="col-md-4 col-sm-6">
          <div class="contact-item">
            ...
            <div class="contact-item-info">Deulasahi COlony, Cuttack, Odisha</div>
          </div><!-- .contact-item -->
        </div><!-- .col-# -->
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="blog-entry">
            ...
            <div class="blog-entry-content">
              <p>Construction offer you the best in metal roofing services, supplies and materials to help protect one
                of your biggest investments you will ever make, your home. There is no better way to protect …</p>
        ...
        <div class="col-md-4">
          <div class="blog-entry">
            ...
            <div class="blog-entry-content">
              <p>By choosing to build green, you aremaking an effort to reduce the burden on the environment and also
                add value to your home. Construction provides you with the guidance and the tools that are necessary …
              </p>
              <p><a href="#" class="read-more">Read more &#43;</a></p>
            </div><!-- .blog-entry-content -->
          </div><!-- .blog-entry -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-4 text-right marg-20-top">
          <a href="/contact" class="button">Let's talk together</a>
        </div>
      </div><!-- .row -->
    </div><!-- .container -->
  </div><!-- #cta -->
    ...
    <div class="container-fluid container-no-padding">
      <div class="row row-no-margin">
        <div class="image-block-item col-md-6 col-sm-5 col-xs-12">
          <div class="image-block-item-background" style="background-image: url('assets/img/img-post-content-04.jpg');">
          </div>
    ...
    <div class="container clear">
      <div class="row">
        <div
          ...
          <p><strong>J construction </strong>is your best home , office renovation and construction solution.
            We started since 2005.</p>
          <p>For more than 15 years , jconstruction has offered a wide range of construction services in <strong>
              Cuttack, odisha.</strong>
            With hundreds of successful project under our belt , we can proudly say that we are one</p>
          <p><a class="button btn-danger popup-video" href="http://www.youtube.com/watch?v=Og879fOk6DQ"><i
                class="fa fa-wrench"></i> Learn Our Service</a></p>
        </div><!-- .col-## -->
      </div><!-- .row -->
    </div><!-- .container -->
  </div><!-- #about -->
        ...
        <div class="col-md-3 col-sm-6">
          <div class="process-item highlight text-center">
            ...
            <div class="process-item-content">
              ...
              <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring my
                whole heart.</p>
    ...
    <div class="container-fluid container-no-padding">
      <div class="row row-no-margin">
        <div class="image-block-item col-md-6 col-md-offset-6 col-sm-5 col-xs-12">
          <div class="image-block-item-background" style="background-image: url('assets/img/img-content-03.jpg');">
          </div>
        </div><!-- .image-block-item -->
      </div><!-- .row -->
    </div><!-- .container-fluid -->
          ...
          <div class="carousel slide testimony-dark" id="testimony" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="item active">
                <p>Recently we had to redesign our landing page and were looking for a template that fit our needs. We
                  found this template which far exceeded our expectations</p>
              ...
              <div class="item">
                <p>I don't know what else to say. It had everything we wanted and was better designed than anything we
                  could have accomplished on our own. Thanks for the great work.</p>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <section class="widget">
            <img src="assets/img/img-logo-footer.png" alt="bootstrap theme for construction companies"
              class="img-responsive marg-20-btm marg-20-top">
            <p>Construction company based on Orange, California. Construction was very sufficient in maintaining the
              integrity of project in terms of planning, scheduling, cost and quality.</p>
          </section><!-- .widget -->
        </div><!-- .col-## -->
